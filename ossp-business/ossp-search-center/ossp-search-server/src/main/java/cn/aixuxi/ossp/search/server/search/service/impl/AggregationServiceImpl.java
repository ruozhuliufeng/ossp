...
import cn.aixuxi.ossp.search.client.model.AggItemVO;
import cn.aixuxi.ossp.search.server.search.service.IAggregationService;
...
public class AggregationServiceImpl implements IAggregationService {
    ...
    public Map<String, Object> requestStatAgg(String indexName, String routing) throws IOException {
        ...
        if (aggregations != null){
            ...
            setTermsData(result,aggregations,"brower");
    ...
    /**
     * 2021-09-04 14:56 获取时间值 09-04 14:56
     * @param datetimeStr 时间值
     * @return String
     */
