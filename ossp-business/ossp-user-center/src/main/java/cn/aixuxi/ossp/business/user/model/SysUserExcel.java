...
public class SysUserExcel implements Serializable {
    ...
    @Excel(name = "创建时间",format = CommonConstant.DATETIME_FORMAT,width = 30,isImportField = "true_st")
    private Date createTime;

    @Excel(name = "修改时间",format = CommonConstant.DATETIME_FORMAT,width = 30,isImportField = "true_st")
