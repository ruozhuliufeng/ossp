package cn.aixuxi.ossp.business.code.service.impl;

import cn.aixuxi.ossp.business.code.mapper.SysGeneratorMapper;
import cn.aixuxi.ossp.business.code.service.SysGeneratorService;
import cn.aixuxi.ossp.business.code.utils.GenUtils;
...
public class SysGeneratorServiceImpl extends ServiceImpl implements SysGeneratorService {
    ...
    public PageResult queryList(Map<String, Object> map) {
        Page<Map<String,Object>> page = new Page<>(MapUtils.getInteger(map,"page"),
                MapUtils.getInteger(map,"limit"));
    ...
    public byte[] generatorCode(String[] tableNames) {
        ...
        try (
            ...
            log.error("代码生成错误！错误原因：{}",e.getMessage());
        }
